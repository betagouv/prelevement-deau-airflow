...
def upgrade() -> None:
    ...
    op.execute("CREATE SCHEMA IF NOT EXISTS prelevement_deau")
    op.create_table(
        "dossier",
        ...
        schema="prelevement_deau",
    )
    op.create_index(
        op.f("ix_prelevement_deau_dossier_date_created"),
        "dossier",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_error_mail_date_created"),
        "error_mail",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_error_mail_id_dossier"),
        "error_mail",
        ["id_dossier"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id_dossier"], ["prelevement_deau.dossier.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="prelevement_deau",
    )
    op.create_index(
        op.f("ix_prelevement_deau_avis_date_created"),
        "avis",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_donnees_point_de_prelevement_aep_zre_date_created"),
        "donnees_point_de_prelevement_aep_zre",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_donnees_prelevement_citerne_date_created"),
        "donnees_prelevement_citerne",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_message_date_created"),
        "message",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_prelevement_citerne_valeur_par_valeur_date_created"),
        "prelevement_citerne_valeur_par_valeur",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_relever_index_date_created"),
        "relever_index",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id_avis"], ["prelevement_deau.avis.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="prelevement_deau",
    )
    op.create_index(
        op.f("ix_prelevement_deau_avis_piece_jointe_date_created"),
        "avis_piece_jointe",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_index(
        op.f("ix_prelevement_deau_donnees_prelevement_aep_zre_date_created"),
        "donnees_prelevement_aep_zre",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id_message"], ["prelevement_deau.message.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="prelevement_deau",
    )
    op.create_index(
        op.f("ix_prelevement_deau_message_piece_jointe_date_created"),
        "message_piece_jointe",
        ["date_created"],
        unique=False,
        schema="prelevement_deau",
...
def downgrade() -> None:
    ...
    op.drop_table("message_piece_jointe", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_donnees_prelevement_aep_zre_date_created"),
        table_name="donnees_prelevement_aep_zre",
        schema="prelevement_deau",
    )
    op.drop_table("donnees_prelevement_aep_zre", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_avis_piece_jointe_date_created"),
        table_name="avis_piece_jointe",
        schema="prelevement_deau",
    )
    op.drop_table("avis_piece_jointe", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_relever_index_date_created"),
        table_name="relever_index",
        schema="prelevement_deau",
    )
    op.drop_table("relever_index", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_prelevement_citerne_valeur_par_valeur_date_created"),
        table_name="prelevement_citerne_valeur_par_valeur",
        schema="prelevement_deau",
    )
    op.drop_table("prelevement_citerne_valeur_par_valeur", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_message_date_created"),
        table_name="message",
        schema="prelevement_deau",
    )
    op.drop_table("message", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_donnees_prelevement_citerne_date_created"),
        table_name="donnees_prelevement_citerne",
        schema="prelevement_deau",
    )
    op.drop_table("donnees_prelevement_citerne", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_donnees_point_de_prelevement_aep_zre_date_created"),
        table_name="donnees_point_de_prelevement_aep_zre",
        schema="prelevement_deau",
    )
    op.drop_table("donnees_point_de_prelevement_aep_zre", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_avis_date_created"),
        table_name="avis",
        schema="prelevement_deau",
    )
    op.drop_table("avis", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_error_mail_id_dossier"),
    ...
    op.drop_table("error_mail", schema="prelevement_deau")
    op.drop_index(
        op.f("ix_prelevement_deau_dossier_date_created"),
        table_name="dossier",
        schema="prelevement_deau",
    )
    op.drop_table("dossier", schema="prelevement_deau")
    # ### end Alembic commands ###
