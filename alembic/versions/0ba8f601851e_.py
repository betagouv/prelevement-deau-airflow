...
Revision ID: 0ba8f601851e
Revises:
Create Date: 2024-08-30 04:21:32.496562
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_dossier_date_created"), "dossier", ["date_created"], unique=False
    )
    op.create_table(
        "error_mail",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["id_dossier"], ["dossier.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_avis_date_created"), "avis", ["date_created"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_donnees_point_de_prelevement_aep_zre_date_created"),
        "donnees_point_de_prelevement_aep_zre",
        ["date_created"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_donnees_prelevement_citerne_date_created"),
        "donnees_prelevement_citerne",
        ["date_created"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_message_date_created"), "message", ["date_created"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_prelevement_citerne_valeur_par_valeur_date_created"),
        "prelevement_citerne_valeur_par_valeur",
        ["date_created"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_relever_index_date_created"),
        "relever_index",
        ["date_created"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["id_avis"], ["avis.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_avis_piece_jointe_date_created"),
        "avis_piece_jointe",
        ["date_created"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["donnees_point_de_prelevement_aep_zre_id"],
            ["donnees_point_de_prelevement_aep_zre.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_donnees_prelevement_aep_zre_date_created"),
        "donnees_prelevement_aep_zre",
        ["date_created"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["id_message"], ["message.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_message_piece_jointe_date_created"),
        "message_piece_jointe",
        ["date_created"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_message_piece_jointe_date_created"), table_name="message_piece_jointe"
    )
    op.drop_table("message_piece_jointe")
    op.drop_index(
        op.f("ix_donnees_prelevement_aep_zre_date_created"),
        table_name="donnees_prelevement_aep_zre",
    )
    op.drop_table("donnees_prelevement_aep_zre")
    op.drop_index(
        op.f("ix_avis_piece_jointe_date_created"), table_name="avis_piece_jointe"
    )
    op.drop_table("avis_piece_jointe")
    op.drop_index(op.f("ix_relever_index_date_created"), table_name="relever_index")
    op.drop_table("relever_index")
    op.drop_index(
        op.f("ix_prelevement_citerne_valeur_par_valeur_date_created"),
        table_name="prelevement_citerne_valeur_par_valeur",
    )
    op.drop_table("prelevement_citerne_valeur_par_valeur")
    ...
    op.drop_table("donnees_prelevement_citerne")
    op.drop_index(
        op.f("ix_donnees_point_de_prelevement_aep_zre_date_created"),
        table_name="donnees_point_de_prelevement_aep_zre",
    )
    op.drop_table("donnees_point_de_prelevement_aep_zre")
