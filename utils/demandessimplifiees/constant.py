champs_text_db_labels = {
    ...
    'Champ-3988469': 'mode_transmission_donnees',
...
champs_checkbox_db_labels = {'Champ-2379086': "validation_informations",
                             'Champ-3888495': 'details_prelevements',
                             'Champ-3660667': "donnees_compteur_volumetrique",
                             'Champ-2378798': 'compteur_lecture_directe',
                             'Champ-2378987': 'signalement_panne_compteur',
                             'Champ-4153004': 'prelevement_autorise_mois_precedent',
                             'Champ-4152855': 'au_moins_un_prelevement'}

champs_date_db_labels = {'Champ-3988441': 'date_debut_declaration',
                         'Champ-3988442': 'date_fin_declaration'}

champs_integer_number_db_labels = {
    'Champ-3902209': 'annee_prelevement'
}

champs_dropdown_db_labels = {
...
champs_piece_justificative_db_labels = {
    'Champ-3988475': "tableau_de_suivi"  # Tableau de suivi
}
